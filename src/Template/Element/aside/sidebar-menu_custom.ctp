...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        <a href="/questions">
            <i class="fa  fa-question-circle"></i> <span>My Questions</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
    </li>
    <li class="treeview">
        <a href="/questions">
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa  fa-users"></i> <span>Friends</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
    </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('#'); ?>"><i class="fa fa-circle-o"></i> Example 1</a></li>
            <li><a href="<?php echo $this->Url->build('#'); ?>"><i class="fa fa-circle-o"></i> Example 2</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
            <i class="fa  fa-balance-scale"></i> <span>My statistic</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
    </li>
